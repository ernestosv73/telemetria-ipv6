...
* Todos los scripts fueron integrados y controlados por el Sistema de Control de Procesos Supervisord. Ejecutar desde el nodo **gNMIc** el comando `supervisord -c supervisord.conf`
